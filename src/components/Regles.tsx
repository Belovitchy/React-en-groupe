        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-2 text-sm sm:text-base text-gray-700">
              ...
              <li>Une cellule morte avec exactement 3 voisines vivantes devient vivante.</li>
              <li>Dans tous les autres cas, une cellule meurt ou reste morte.</li>
            </ul>
            <p className="mt-4 text-xs text-gray-500 text-center">
              Ces règles sont appliquées à chaque génération à toutes les cellules en même temps.
            </p>
